...
if (check == -1) { document.theSpreadsheet.expr.value = ""; document.theSpreadsheet.output.value = "" ; okToRoll = false; return(666);}
...
if  (TableauNumber > maxSteps) document.theSpreadsheet.expr.value = ""

else if (singular) document.theSpreadsheet.expr.value = ""

else

	{

	document.theSpreadsheet.expr.value = "Solucion Óptima: " + objectiveName + " = ";
...
// alert("tableau is set up");
	...
	// Option 2 // preliminary checks
		...
		if (document.theSpreadsheet.input.value == "") {document.theSpreadsheet.expr.value = ""; okToRoll = false; }
